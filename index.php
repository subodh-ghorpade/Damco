...
echo 'Latern fish with 80 days and given input '.$programClass->countLanternFish($input, 80); // returns 354564

echo '<br>';
echo '<hr>';


echo 'Latern fish with 256 days and given input '.$programClass->countLanternFish($input, 256); // returns 1609058859115